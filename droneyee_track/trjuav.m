function [x,y,z] =trjuav(timestamp,num,flagg,stat,trj_flag,form_flag,avo_flag)
point_time=0;
zstart=-0.5;
% w1=0.1;
% w2=0.1;
...
%  y=r*sin(w*t+num*2*pi/4);
 ...
 r=1.5;
 w=0.03;
 x=r*cos(2*w*t+num*2*pi/4)*cos(w*t+num*2*pi/4);
 y=r*cos(2*w*t+num*2*pi/4)*sin(w*t+num*2*pi/4);
